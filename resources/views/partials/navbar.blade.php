...
<nav class="layout-navbar navbar navbar-expand-xl align-items-center" id="layout-navbar">
    <div class="container-xxl">
        ...
        <!-- LOGO PARA MÓVIL -->
        <div class="navbar-brand d-flex d-md-none align-items-center mx-auto">
            <a href="{{ url('/') }}">
        ...
        <div class="layout-menu-toggle navbar-nav align-items-center me-3 d-md-none">
        ...
        <div class="navbar-nav-right d-none d-md-flex align-items-center justify-content-end" id="navbar-collapse">
