<footer class="bg-dark text-light py-5 mt-5 border border-danger">
  ...
  <div class="container text-center">
    ...
    <!-- Logo -->
    <div class="mb-4">
      <img src="{{ asset('assets/img/logo.png') }}" alt="AlaGlider Logo" width="180">
    </div>

    <!-- Enlaces -->
    <div class="mb-3">
      <a href="javascript:void(0)" class="text-light me-3" data-bs-toggle="modal" data-bs-target="#privacyModal">
        Aviso de Privacidad
      </a>
      <span>|</span>
      <span class="ms-3">© Todos los derechos reservados a alaglider.com</span>
    </div>

    <!-- Redes sociales -->
    <!-- Redes sociales con imágenes personalizadas -->
    <div class="mb-4 d-flex justify-content-center gap-3">
    <a href="https://facebook.com/AlaGlider#" target="_blank">
        <img src="{{ asset('assets\img\icons\brands\facebook.png') }}" alt="Facebook" class="social-icon">
    </a>
    <a href="https://x.com/ala_glider" target="_blank">
        <img src="{{ asset('assets\img\icons\brands\twitter.png') }}" alt="Twitter" class="social-icon">
    </a>
    <a href="https://instagram.com/alaglider/" target="_blank">
        <img src="{{ asset('assets\img\icons\brands\instagram.png') }}" alt="Instagram" class="social-icon">
    </a>
    <a href="https://youtube.com/channel/UCcagZbHcl_InjuwAYMedhPQ" target="_blank">
        <img src="{{ asset('assets\img\icons\brands\youtube.png') }}" alt="YouTube" class="social-icon">
    </a>
    </div>


    <!-- Formas de pago -->
    <h6 class="mb-3">Nuestras formas de pago</h6>
    <div class="d-flex justify-content-center align-items-center flex-wrap gap-3">
      <img src="{{ asset('assets\img\icons\payments\paypal_logo.png') }}" alt="PayPal" height="40">
      <img src="{{ asset('assets\img\icons\payments\stripe-logo.png') }}" alt="Stripe" height="40">
      <img src="{{ asset('assets\img\icons\payments\mercado.png') }}" alt="Mercado Libre" height="40">
    </div>
  </div>
</footer>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-start">
        <p>
          ...
          Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin tu consentimiento, salvo que sea requerido por un juez con una orden judicial. Ala Glider se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
        </p>
      </div>
    </div>
  </div>
