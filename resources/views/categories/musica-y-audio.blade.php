...
<head>
    <meta charset="utf-8" />
    <title>Música y Audio - AlaGlider</title>
                ...
                <div class="content-wrapper">
                    ...
                    <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu flex-grow-0">
                        <div class="container-xxl d-flex h-100 justify-content-center align-items-center">
                            <ul class="menu-inner">
                                ...
                                <li class="menu-item {{ $category->slug === 'musica-y-audio' ? 'active' : '' }}">
                    ...
                    <div class="container section-spacing mb-5">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <!-- Sesiones Musicales -->
                            <div class="col-12 col-sm-6 col-md-3 mb-4 text-center">
                                <a href="{{ url('/category/marketing-digital/sesionesmusicales') }}" class="subcat-card">
                            ...
                            <div class="col-12 col-sm-6 col-md-3 mb-4 text-center">
                                <a href="{{ url('/category/marketing-digital/produccionesycomposiciones') }}" class="subcat-card">
